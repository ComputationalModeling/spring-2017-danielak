...
| $D$    | Density of the Fluid               | 1.184 $kg/m^3$ for air at $25 \deg$           |
| $A$    | Cross-Sectional Area of the Object | $1\textrm{m}^2$ (it's a huge cannonball) |
| $v$    | velocity of the cannonball         | 0, initially                                  |


When we substitute in our values, we get this equation for our cannonball

$$\vec{F}_{\textrm{drag}} = \frac{1}{2}(1)(1.184\textrm{kg/m^3})(\pi(0.5\textrm{m})^2) \vec{v}^2

$$

Which computes out to

$$ \vec{F}_{\textrm{drag}} \approx 0.465 \times \vec{v}^2 $$

$$ \vec{a}_\textrm{drag} = 

    \frac{\vec{F}_\textrm{drag}}{m_\textrm{cannon ball}}
    = \frac{0.4650 \times \vec{v}^2}{4123 \mathrm{kg}}$$

And finally, we have our acceleration due to drag purely in terms of our velocity:

$$ \vec{a}_\textrm{drag} = 0.0001521 \times \vec{v}^2$$
